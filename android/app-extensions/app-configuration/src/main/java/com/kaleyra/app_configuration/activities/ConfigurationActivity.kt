...
open class ConfigurationActivity : BaseConfigurationActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.e("currentConfig=>:", currentConfiguration.toString())
    ...
    fun updateConfiguration(api: String, id: String, env : String, region: String, config: Configuration) {
        Log.e("updated:", config.toJson())
        currentConfiguration = config
        Log.d(api, id)
        Log.d(env, region)
        currentConfiguration?.apiKey = api
        currentConfiguration?.appId = id
        currentConfiguration?.environment = env
        currentConfiguration?.region = region
        Log.e("updated:", currentConfiguration.toString())
//
//        sendBroadcastConfigurationResult(CONFIGURATION_ACTION_UPDATE, currentConfiguration)

//        currentConfiguration!!.apiKey = "abc"
//        currentConfiguration!!.appId = "123"
//        currentConfiguration!!.environment = "ppp"
    }
